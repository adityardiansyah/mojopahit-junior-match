    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">Formulir Tambah Club</h3>
            </div>
            ...
            <div class="col-md-12">
                <div class="kt-portlet kt-portlet--mobile">
                    <div class="kt-portlet__body pt-2">
                        <div class="kt-heading kt-heading--md">Tambah Club</div>
                        @if ($errors->any())
                    ...
                    <div class="modal-body">
                            <table class="mt-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <label for="">Foto Perwakilan</label>
