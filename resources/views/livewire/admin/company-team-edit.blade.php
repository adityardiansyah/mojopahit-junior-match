                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input wire:model="team_id" type="hidden" class="form-control" name="team_id" >
                    ...
                    <div class="col-md-4">
                        <label for="image">Foto</label> &nbsp; @if($image) <a href="{{ asset('storage/'.$image) }}">Lihat Foto</a>@endif
                        <input type="file" wire:model="imageUpdate" name="image" id="image" class="form-control">
                    </div>
                </div>
            </table>
        </div>
