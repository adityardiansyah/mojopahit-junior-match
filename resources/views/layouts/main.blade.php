...
<div class="page-wrapper">
  ...
  <footer class="main-footer alternate">
                        ...
                        <div class="footer-column">
                            <div class="footer-widget about-widget">
                                ...
                                <div class="text"></div>
                                    <ul class="social-icon-one">
                                        <li><a href=""><span class="fab fa-facebook-f"></span></a></li>
                                        {{-- <li><a href="{{ $contacts['ig'][0]['text']}}"><span class="fab fa-instagram"></span></a></li> --}}
                                    </ul>
                                ...
                                <div class="footer-widget contact-widget">
                                    ...
                                    <div class="widget-content">
                                        <ul class="contact-list">
                                            <li><i class="material-icons">place</i>{{ $contacts['alamat'][0]['number'] }}</li>
                                            <li><i class="material-icons">query_builder</i> {{ $contacts['jam'][0]['text'] }}</li>
                                            <li><i class="material-icons">phone</i> <a href="tel:{{$contacts['telp'][0]['number']}}">{{ $contacts['telp'][0]['number'] }}</a></li>
                                            <li><i class="material-icons">email</i> <a href="mailto:{{ $contacts['email'][0]['number'] }}">{{ $contacts['email'][0]['number'] }}</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div> --}}
        ...
        <div class="footer-bottom">
            <div class="auto-container">
                <div class="copyright-text">Copyright © {{ now()->year }} <a href="#">Sedot WC Muda Jaya</a>. All Right Reserved</div>
            </div> 
        </div>
