    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">Formulir Tambah Artikel</h3>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group" wire:ignore>
                                            ...
                                            <textarea type="text" input="description" id="summernote" class="form-control summernote"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </table>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input wire:model="image" type="file" class="form-control" name="image" id="" required>
                                        </div>
                                        <div class="form-group">
